...
CREATE TABLE IF NOT EXISTS `SolicitudRenovacion`.`TA_Licencia` (
  ...
  INDEX `fk_TA_Licencia_TA_Comuna1_idx` (`fk_id_comuna` ASC),
  INDEX `fk_TA_Licencia_TA_Persona1_idx` (`fk_id_persona` ASC),
...
CREATE TABLE IF NOT EXISTS `SolicitudRenovacion`.`TA_Fecha` (
  ...
  INDEX `fk_TA_Fecha_TA_Persona1_idx` (`fk_id_persona` ASC),
  CONSTRAINT `fk_TA_Fecha_TA_Persona1`
    FOREIGN KEY (`fk_id_persona`)
    REFERENCES `SolicitudRenovacion`.`TA_Persona` (`id_persona`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
